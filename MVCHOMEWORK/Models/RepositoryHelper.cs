namespace MVCHOMEWORK.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_CustomerContactorBankCountRepository Getvw_CustomerContactorBankCountRepository()
		{
			var repository = new vw_CustomerContactorBankCountRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_CustomerContactorBankCountRepository Getvw_CustomerContactorBankCountRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_CustomerContactorBankCountRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
